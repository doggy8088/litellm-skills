...
需要設定範例、fallback mock 或 health endpoint 細節時，讀取 [實驗與參考](references/guide.md)；涉及 Azure 多區、endpoint mode 或 route matrix 時，讀取 [本機路由模式](references/local-routing-patterns.md)。
